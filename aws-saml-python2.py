...
# Fix boto - The Metadata Service can timeout whilst retrieving credentials
#try:
...
idpentryurl = 'https://fs.teradici.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices'
...
print "Username / email address (for SSO):",
username = raw_input()
...
conn = boto.sts.STSConnection(anon=True)
